...
CC_SRC_PATH="../chaincode/smallbank/go/"
...
./network.sh deployCC -ccn smallbank -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH} -ccep ${CC_END_POLICY}
popd
...
# create leadger
# cd nisl-go-sdk
# go run nisl-go-sdk -opt=create -cck=default
